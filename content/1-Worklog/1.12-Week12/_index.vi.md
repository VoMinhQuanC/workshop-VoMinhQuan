...
### Mục tiêu tuần 12:
* Kiểm tra, hoàn thiện và nghiệm thu các hạng mục đã triển khai của project nhóm.
* Bàn giao các tài nguyên liên quan của dự án nhóm cho công ty.
* Hoàn thiện các biểu mẫu và yêu cầu của báo cáo thực tập cuối kỳ.
...
* Hoàn tất việc kiểm tra, hoàn thiện và nghiệm thu các hạng mục chính của project nhóm.
* Bàn giao lại các tài nguyên liên quan của dự án cho công ty theo đúng yêu cầu.
* Hoàn thiện các nội dung và biểu mẫu cần thiết để kết thúc báo cáo thực tập cuối kỳ.